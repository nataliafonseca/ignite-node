...
var AuthenticateUserUseCase = /** @class */ (function () {
    ...
    AuthenticateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordChecksOut, token, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.AppError('Invalid email/password combination.');
                        }
                        return [4 /*yield*/, bcrypt_1.compare(password, user.password)];
                    case 2:
                        passwordChecksOut = _b.sent();
                        if (!passwordChecksOut) {
                            throw new AppError_1.AppError('Invalid email/password combination.');
                        }
                        token = jsonwebtoken_1.sign({}, '10378cc6f61f1c1e7421b54b4176c59d', {
                            subject: user.id,
                            expiresIn: '1d',
                        });
                        tokenReturn = {
