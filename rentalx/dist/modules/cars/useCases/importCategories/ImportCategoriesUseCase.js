...
var ImportCategoriesUseCase = /** @class */ (function () {
    function ImportCategoriesUseCase(categoriesRepository) {
        this.categoriesRepository = categoriesRepository;
    }
    ImportCategoriesUseCase.prototype.loadCategories = function (file) {
        var _this = this;
    ...
    ImportCategoriesUseCase.prototype.execute = function (file) {
    ...
    ImportCategoriesUseCase = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('CategoriesRepository')),
        __metadata("design:paramtypes", [Object])
    ], ImportCategoriesUseCase);
    return ImportCategoriesUseCase;
}());
